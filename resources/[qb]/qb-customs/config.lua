...
bennyGarages = {
    [1] = {coords = vector4(-210.45, -1323.14, 30.22, 327.43), useJob = true, job = {"mechanic"}},
    [2] = {coords = vector4(-35.13, -1052.43, 27.72, 354.7) , useJob = true, job = {"mechanic"}},  
    [3] = {coords = vector4(109.89, 6627.07, 31.78, 221.7938), useJob = true, job = {"mechanic"}},
    [4] = {coords = vector4(539.79, -179.2, 53.81, 266.28), useJob = true, job = {"mechanic"}},
    [5] = {coords = vector4(-338.45, -136.72, 38.83, 272.65), useJob = true, job = {"mechanic"}},

    [6] = {coords = vector4(1019.58, -2309.52, 29.86, 266.35), useJob = true, job = {"mechanic"}},
    [7] = {coords = vector4(1019.13, -2315.8, 29.86, 269.85) , useJob = true, job = {"mechanic"}},  
    [8] = {coords = vector4(1018.65, -2322.13, 29.86, 267.58), useJob = true, job = {"mechanic"}},
    [9] = {coords = vector4(1018.86, -2328.19, 29.86, 269.68), useJob = true, job = {"mechanic"}},
    [10] = {coords = vector4(1018.53, -2334.77, 29.86, 272.73), useJob = true, job = {"mechanic"}},
