...
Config = {
    ...
    webhook = "https://discordapp.com/api/webhooks/1122215664371892246/221mNyF_O0HJkpduueHxzxcq7jlU_vRd9cAdxIE0lzoCGuPsNZjf1ZYT1hD6cF_LgyXQ", -- Add Discord webhook
    UsePsMDT = false,
}
