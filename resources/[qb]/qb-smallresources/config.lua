...
Config.Discord = {
    ...
    ["ApplicationId"] = '1105497306951847986', -- The discord application id
    ["IconLarge"] = 'logo_name', -- The name of the large icon
    ["IconLargeHoverText"] = 'GateOfDrame.RP', -- The hover text of the large icon
    ["IconSmall"] = 'small_logo_name', -- The name of the small icon
    ["IconSmallHoverText"] = 'GateOfDrame.RP', -- The hover text of the small icon
    ...
    ["Buttons"] = {
        {
            text = 'Connect Server!',
            url = 'connect gateofdrama.ddns.net'
        },
        {
            text = 'Second Button!',
            url = 'https://discord.gg/MnH9V5Cdr5'
        }
    }
}
...
Config.MapText = "Gate Of Drama.P" -- This is the name / text shown above the map
