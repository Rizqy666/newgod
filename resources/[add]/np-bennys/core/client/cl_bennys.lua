...
local function saveVehicle()
    ...
    local appearance = exports["np-vehicles"]:GetVehicleAppearance(veh)
    local mods = exports["np-vehicles"]:GetVehicleMods(veh)
    TriggerServerEvent('np-vehicles:updateVehicle', plate, appearance, mods)
end
